...
import { listSites, deleteSite, SavedSite, buildStaticHtmlDocument } from "@/features/website";
            ...
            <div key={site.slug} className="flex flex-col rounded-xl border p-5">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2 text-sm">
                ...
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-1.5 rounded-lg px-3 py-2 font-medium text-red-600 hover:bg-red-50"
                >
